...
CREATE TABLE tbl_ClienteCTRC (
	...
	IdCliente INT FOREIGN KEY REFERENCES tbl_ClienteDest(IdCliente) NULL,
	IdCtrc INT FOREIGN KEY REFERENCES tbl_CTRC (IdCtrc) NULL,
 	tipo VARCHAR(20) NULL -- Destinatário ou Remetente
);
...
INSERT INTO tbl_ClienteReme(nmCli_Rementente,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Pescados SP', 'Rua Joaquim Silva, 375-Bairro do Limão', 'São Paulo', 'SP', '77551122000170', '', '(11) 2260-2780');
INSERT INTO tbl_ClienteReme(nmCli_Rementente,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Minérios Ouro', 'Rua Silva Jardim, 115-Bairro Três Marias', 'Extrema', 'MG', '88443311000171', '', '(35) 2233-2781');
INSERT INTO tbl_ClienteReme(nmCli_Rementente,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Laticínios da Vovó', 'Rua Presidente Kennedy,1000 - Centro', 'Extrema', 'MG', '33557788000172', '', '(35) 4422-2782');
INSERT INTO tbl_ClienteReme(nmCli_Rementente,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Autometal', 'Rod. Anchieta, 1375-Centro','São Paulo', 'SP', '44335522000173', '', '(11) 5522-2783');
INSERT INTO tbl_ClienteReme(nmCli_Rementente,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Eletrônicos SA', 'Rua Caminho do Mar, 6670-Bairro Saúde', 'Santos', 'SP', '55443311000174', '', '(13) 5566-2784');

	-- Inserir Clientes_Destinatário

	-- DELETE tbl_ClienteDest WHERE IdCliente>'0'
	-- SELECT * FROM tbl_ClienteDest

INSERT INTO tbl_ClienteDest(nmCli_Destinatario,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Hipermercado Extra', 'Rua Maria da Penha, 3000-Centro', 'Cotia', 'SP', '22336655000155', '', '(11) 8899-5005');
INSERT INTO tbl_ClienteDest(nmCli_Destinatario,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Lapidadora Sergipe', 'Rua Sol,8700-Bairro das Flores', 'Arauã', 'SE', '', '23165498700', '(79) 2233-4004');
INSERT INTO tbl_ClienteDest(nmCli_Destinatario,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Distribuidora São João', 'Rua Airton Senna, 6500-Bairro Limeira', 'São Paulo', 'SP', '22558899000157', '', '(11) 2211-4003');
INSERT INTO tbl_ClienteDest(nmCli_Destinatario,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('Auto Peças Kabum', 'Rua Joaquim Nabuco, 37-Bairro Ferraz Alvim', 'Salvador', 'BA', '11447788000158', '', '(11) 7744-3002');
INSERT INTO tbl_ClienteDest(nmCli_Destinatario,nmEndereco,nmCidade,uf,cnpjCliente, cpfCliente, nmTelefone) VALUES ('BIG Cell', 'Rua Netuno, 66-Bairro Limpão', 'Petrópolis', 'RJ', '11223344000159', '', '(21) 6699-3001');
...
INSERT INTO tbl_CTRCManifesto(nmMotorista, nrPlaca_Veiculo, nmFilial_Origem, nmFilial_Destino, nmCli_Rementente, nmCli_Destinatario, qtPesoFrete, vlFrete,IdMotorista, IdVeiculo,IdManifesto,IdCli_Reme,IdCliente, IdCtrc) VALUES ('João da Silva','AAA-1111', 'CD Santos','CD Cotia', 'Pescados SP', 'Hipermercado Extra','5000', '3750',1,1,1,1,1,1);
INSERT INTO tbl_CTRCManifesto(nmMotorista, nrPlaca_Veiculo, nmFilial_Origem, nmFilial_Destino, nmCli_Rementente, nmCli_Destinatario, qtPesoFrete, vlFrete,IdMotorista, IdVeiculo,IdManifesto,IdCli_Reme,IdCliente, IdCtrc) VALUES ('Maria do Luz,','BBA-2222', 'CD Minas Gerais','CD Aracaju','Minérios Ouro', 'Lapidadora Sergipe','3950','12750',2,2,2,2,2,2);
INSERT INTO tbl_CTRCManifesto(nmMotorista, nrPlaca_Veiculo, nmFilial_Origem, nmFilial_Destino, nmCli_Rementente, nmCli_Destinatario, qtPesoFrete, vlFrete,IdMotorista, IdVeiculo,IdManifesto,IdCli_Reme,IdCliente, IdCtrc) VALUES ('Fernando Gois','CCC-3333', 'CD Minas Gerais','CD São Paulo', 'Laticínios da Vovó', 'Distribuidora São João','3000', '5300',3,3,3,3,3,3);
INSERT INTO tbl_CTRCManifesto(nmMotorista, nrPlaca_Veiculo, nmFilial_Origem, nmFilial_Destino, nmCli_Rementente, nmCli_Destinatario, qtPesoFrete, vlFrete,IdMotorista, IdVeiculo,IdManifesto,IdCli_Reme,IdCliente, IdCtrc) VALUES ('Márcia Feliz','DDD-4444', 'CD São Paulo','CD Bahia', 'Autometal', 'Auto Peças Kabum', '5000', '9750',4,4,4,4,4,4);
INSERT INTO tbl_CTRCManifesto(nmMotorista, nrPlaca_Veiculo, nmFilial_Origem, nmFilial_Destino, nmCli_Rementente, nmCli_Destinatario, qtPesoFrete, vlFrete,IdMotorista, IdVeiculo,IdManifesto,IdCli_Reme,IdCliente, IdCtrc) VALUES ('Marcos Rueda','EEE-5555', 'CD Santos','CD Rio de Janeiro', 'Eletrônicos SA', 'BIG Cell','900', '9310',5,5,5,5,5,5);
